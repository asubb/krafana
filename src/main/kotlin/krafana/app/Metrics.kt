...
val telemetryMetricPusherExceptionSize99pct = metric("${telemetry}_metric_pusher_exception_size_99pct")
val telemetryMetricPusherFailedDuration99pct = metric("${telemetry}_metric_pusher_failed_duration_99pct")
val telemetryMetricPusherExceptionDuration99pct = metric("${telemetry}_metric_pusher_exception_duration_99pct")
val telemetryMetricPusherFailedDatapoints99pct = metric("${telemetry}_metric_pusher_failed_datapoints_99pct")
val telemetryMetricPusherExceptionDatapoints99pct = metric("${telemetry}_metric_pusher_exception_datapoints_99pct")
